...
StaticPages.attachSchema(Schemas.Pages);

/**
 * Inbound Analytics Collection
 */
export const InboundAnalyticsEvents = new Mongo.Collection("InboundAnalyticsEvents");

InboundAnalyticsEvents.attachSchema(Schemas.InboundAnalyticsEvents);
...
/**
 * SmsSetting collection
 */

export const SmsSetting = new Mongo.Collection("SmsSetting");
